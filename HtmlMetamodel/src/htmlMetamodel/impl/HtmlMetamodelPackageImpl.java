...
public class HtmlMetamodelPackageImpl extends EPackageImpl implements HtmlMetamodelPackage {
	 ...
	 * @generated
	 */
	private EClass atributeEClass = null;
	...
	public static HtmlMetamodelPackage init() {
		...
		HtmlMetamodelPackageImpl theHtmlMetamodelPackage = (HtmlMetamodelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof HtmlMetamodelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new HtmlMetamodelPackageImpl());
	 ...
	 * @generated
	 */
	public EReference getApp_Pages() {
	 ...
	 * @generated
	 */
	public EReference getTag_Atributos() {
	 ...
	 * @generated
	 */
	public EClass getAtribute() {
		return atributeEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getAtribute_Name() {
		return (EAttribute)atributeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getAtribute_Value() {
		return (EAttribute)atributeEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(appEClass, APP__PAGES);
		...
		createEReference(tagEClass, TAG__ATRIBUTOS);
		createEAttribute(tagEClass, TAG__ID);
		createEReference(tagEClass, TAG__TAGS);

		atributeEClass = createEClass(ATRIBUTE);
		createEAttribute(atributeEClass, ATRIBUTE__NAME);
		createEAttribute(atributeEClass, ATRIBUTE__VALUE);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getApp_Pages(), this.getPage(), null, "pages", null, 0, -1, App.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTag_Atributos(), this.getAtribute(), null, "atributos", null, 0, -1, Tag.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(atributeEClass, Atribute.class, "Atribute", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAtribute_Name(), ecorePackage.getEString(), "name", null, 0, 1, Atribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAtribute_Value(), ecorePackage.getEString(), "value", null, 0, 1, Atribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
